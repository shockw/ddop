...
package com.reache.ddop.scheduler.server.worker;
...
import com.reache.ddop.scheduler.plugin.task.api.ProcessUtils;
...
import com.reache.ddop.scheduler.server.worker.registry.WorkerRegistryClient;
import com.reache.ddop.scheduler.server.worker.rpc.WorkerRpcClient;
import com.reache.ddop.scheduler.server.worker.rpc.WorkerRpcServer;
import com.reache.ddop.scheduler.server.worker.runner.WorkerManagerThread;
...
@ComponentScan(basePackages = "com.reache.ddop.scheduler", excludeFilters = {
        @ComponentScan.Filter(type = FilterType.REGEX, pattern = {
                "com.reache.ddop.scheduler.service.process.*",
                "com.reache.ddop.scheduler.service.queue.*",
        })
})
