...
import static com.reache.ddop.scheduler.common.constants.Constants.ADDRESS;
import static com.reache.ddop.scheduler.common.constants.Constants.DATABASE;
import static com.reache.ddop.scheduler.common.constants.Constants.JDBC_URL;
import static com.reache.ddop.scheduler.common.constants.Constants.OTHER;
import static com.reache.ddop.scheduler.common.constants.Constants.PASSWORD;
import static com.reache.ddop.scheduler.common.constants.Constants.SINGLE_SLASH;
import static com.reache.ddop.scheduler.common.constants.Constants.USER;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.CLUSTER;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.TASK_TYPE_DATA_QUALITY;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.TASK_TYPE_K8S;
...
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.SRC_CONNECTOR_TYPE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.SRC_DATASOURCE_ID;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.TARGET_CONNECTOR_TYPE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.TARGET_DATASOURCE_ID;

import com.reache.ddop.scheduler.common.constants.Constants;
import com.reache.ddop.scheduler.common.utils.JSONUtils;
import com.reache.ddop.scheduler.common.utils.PropertyUtils;
...
import com.reache.ddop.scheduler.plugin.task.api.K8sTaskExecutionContext;
...
import com.reache.ddop.scheduler.plugin.task.api.enums.dp.ConnectorType;
import com.reache.ddop.scheduler.plugin.task.api.enums.dp.ExecuteSqlType;
import com.reache.ddop.scheduler.plugin.task.api.model.JdbcInfo;
...
import com.reache.ddop.scheduler.plugin.task.api.parameters.K8sTaskParameters;
import com.reache.ddop.scheduler.plugin.task.api.parameters.ParametersNode;
import com.reache.ddop.scheduler.plugin.task.api.parameters.dataquality.DataQualityParameters;
import com.reache.ddop.scheduler.plugin.task.api.parameters.resource.AbstractResourceParameters;
import com.reache.ddop.scheduler.plugin.task.api.parameters.resource.DataSourceParameters;
import com.reache.ddop.scheduler.plugin.task.api.parameters.resource.ResourceParametersHelper;
import com.reache.ddop.scheduler.plugin.task.api.parameters.resource.UdfFuncParameters;
import com.reache.ddop.scheduler.plugin.task.api.utils.JdbcUrlParser;
...
import com.reache.ddop.scheduler.service.storage.impl.HadoopUtils;
...
import com.reache.ddop.scheduler.spi.plugin.SPIIdentify;
...
import com.reache.ddop.scheduler.server.master.builder.TaskExecutionContextBuilder;
