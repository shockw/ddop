...
import static com.reache.ddop.scheduler.common.constants.Constants.RESOURCE_STORAGE_TYPE;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.DATA_QUALITY_JAR_NAME;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.HADOOP_SECURITY_AUTHENTICATION;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.HADOOP_SECURITY_AUTHENTICATION_STARTUP_STATE;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.JAVA_SECURITY_KRB5_CONF;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.JAVA_SECURITY_KRB5_CONF_PATH;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.KERBEROS;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.LOGIN_USER_KEY_TAB_PATH;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.LOGIN_USER_KEY_TAB_USERNAME;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.RESOURCE_UPLOAD_PATH;

import com.reache.ddop.scheduler.common.enums.ResUploadType;
