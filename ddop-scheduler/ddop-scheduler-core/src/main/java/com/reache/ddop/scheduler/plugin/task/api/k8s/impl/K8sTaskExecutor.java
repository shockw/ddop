...
package com.reache.ddop.scheduler.plugin.task.api.k8s.impl;

import com.reache.ddop.scheduler.common.utils.JSONUtils;
import org.apache.commons.lang3.StringUtils;

import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.API_VERSION;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.CPU;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.EXIT_CODE_FAILURE;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.EXIT_CODE_KILL;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.EXIT_CODE_SUCCESS;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.IMAGE_PULL_POLICY;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.JOB_TTL_SECONDS;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.LAYER_LABEL;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.LAYER_LABEL_VALUE;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.MEMORY;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.MI;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.NAME_LABEL;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.RESTART_POLICY;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.TASK_INSTANCE_ID;
...
import com.reache.ddop.scheduler.plugin.task.api.k8s.AbstractK8sTaskExecutor;
import com.reache.ddop.scheduler.plugin.task.api.k8s.K8sTaskMainParameters;
