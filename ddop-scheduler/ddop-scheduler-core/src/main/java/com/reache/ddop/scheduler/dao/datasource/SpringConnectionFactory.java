...
package com.reache.ddop.scheduler.dao.datasource;
...
public class SpringConnectionFactory {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource, GlobalConfig globalConfig,
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.reache.ddop.scheduler.dao.entity");
        ResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
        sqlSessionFactoryBean
                .setMapperLocations(resolver.getResources("classpath*:com/reache/ddop/scheduler/dao/mapper/*Mapper.xml"));
