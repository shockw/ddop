...
import static com.reache.ddop.scheduler.common.constants.Constants.SEC_2_MINUTES_TIME_UNIT;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.TASK_TYPE_BLOCKING;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.TASK_TYPE_CONDITIONS;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.TASK_TYPE_DEPENDENT;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.TASK_TYPE_SUB_PROCESS;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.TASK_TYPE_SWITCH;
...
import com.reache.ddop.scheduler.plugin.task.api.parameters.SwitchParameters;
