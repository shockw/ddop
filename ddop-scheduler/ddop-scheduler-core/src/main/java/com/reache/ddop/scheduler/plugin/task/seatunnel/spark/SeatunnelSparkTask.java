...
package com.reache.ddop.scheduler.plugin.task.seatunnel.spark;
...
import com.reache.ddop.scheduler.plugin.task.seatunnel.DeployModeEnum;
import com.reache.ddop.scheduler.plugin.task.seatunnel.SeatunnelTask;
import com.reache.ddop.scheduler.plugin.task.seatunnel.spark.SeatunnelSparkParameters.MasterTypeEnum;

import static com.reache.ddop.scheduler.plugin.task.seatunnel.Constants.DEPLOY_MODE_OPTIONS;
import static com.reache.ddop.scheduler.plugin.task.seatunnel.Constants.MASTER_OPTIONS;
