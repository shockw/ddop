...
package com.reache.ddop.scheduler.plugin.task.api.utils;

import com.reache.ddop.scheduler.spi.enums.DbType;

import com.reache.ddop.scheduler.plugin.task.api.model.JdbcInfo;

import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.COLON;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.DOUBLE_SLASH;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.QUESTION;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.SEMICOLON;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.SINGLE_SLASH;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.MYSQL;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.POSTGRESQL;
