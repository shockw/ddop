...
package com.reache.ddop.scheduler.plugin.task.api.parser;

import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.ADD_CHAR;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.ADD_MONTHS;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.ADD_STRING;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.COMMA;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.DIVISION_CHAR;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.DIVISION_STRING;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.LEFT_BRACE_CHAR;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.LEFT_BRACE_STRING;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.MONTH_BEGIN;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.MONTH_END;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.MULTIPLY_CHAR;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.MULTIPLY_STRING;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.N;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.P;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.PARAMETER_FORMAT_TIME;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.RIGHT_BRACE_CHAR;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.SUBTRACT_CHAR;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.SUBTRACT_STRING;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.TIMESTAMP;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.WEEK_BEGIN;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.WEEK_END;
import static org.apache.commons.lang3.time.DateUtils.addWeeks;
import static com.reache.ddop.scheduler.common.utils.DateUtils.addDays;
import static com.reache.ddop.scheduler.common.utils.DateUtils.addMinutes;
import static com.reache.ddop.scheduler.common.utils.DateUtils.addMonths;
