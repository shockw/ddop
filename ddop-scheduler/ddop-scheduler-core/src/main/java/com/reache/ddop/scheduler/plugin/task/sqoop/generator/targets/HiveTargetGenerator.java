...
import static com.reache.ddop.scheduler.plugin.task.sqoop.SqoopConstants.CREATE_HIVE_TABLE;
import static com.reache.ddop.scheduler.plugin.task.sqoop.SqoopConstants.DELETE_TARGET_DIR;
import static com.reache.ddop.scheduler.plugin.task.sqoop.SqoopConstants.HIVE_DATABASE;
import static com.reache.ddop.scheduler.plugin.task.sqoop.SqoopConstants.HIVE_DELIMS_REPLACEMENT;
import static com.reache.ddop.scheduler.plugin.task.sqoop.SqoopConstants.HIVE_DROP_IMPORT_DELIMS;
import static com.reache.ddop.scheduler.plugin.task.sqoop.SqoopConstants.HIVE_IMPORT;
import static com.reache.ddop.scheduler.plugin.task.sqoop.SqoopConstants.HIVE_OVERWRITE;
import static com.reache.ddop.scheduler.plugin.task.sqoop.SqoopConstants.HIVE_PARTITION_KEY;
import static com.reache.ddop.scheduler.plugin.task.sqoop.SqoopConstants.HIVE_PARTITION_VALUE;
import static com.reache.ddop.scheduler.plugin.task.sqoop.SqoopConstants.HIVE_TABLE;
import static com.reache.ddop.scheduler.plugin.task.sqoop.SqoopConstants.TARGET_DIR;
...
import com.reache.ddop.scheduler.plugin.task.sqoop.parameter.targets.TargetHiveParameter;
