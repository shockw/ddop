...
package com.reache.ddop.scheduler.plugin.task.seatunnel;

import static com.reache.ddop.scheduler.plugin.task.seatunnel.Constants.STARTUP_SCRIPT_FLINK;
import static com.reache.ddop.scheduler.plugin.task.seatunnel.Constants.STARTUP_SCRIPT_SEATUNNEL;
import static com.reache.ddop.scheduler.plugin.task.seatunnel.Constants.STARTUP_SCRIPT_SPARK;
...
import com.reache.ddop.scheduler.plugin.task.seatunnel.flink.SeatunnelFlinkTask;
import com.reache.ddop.scheduler.plugin.task.seatunnel.self.SeatunnelEngineTask;
import com.reache.ddop.scheduler.plugin.task.seatunnel.spark.SeatunnelSparkTask;
