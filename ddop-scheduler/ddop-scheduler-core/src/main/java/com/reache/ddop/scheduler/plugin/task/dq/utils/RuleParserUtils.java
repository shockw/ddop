...
package com.reache.ddop.scheduler.plugin.task.dq.utils;
...
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.PARAMETER_BUSINESS_DATE;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.PARAMETER_CURRENT_DATE;
import static com.reache.ddop.scheduler.plugin.task.api.TaskConstants.PARAMETER_DATETIME;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.AND;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.BATCH;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.CHECK_TYPE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.COMPARISON_NAME;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.COMPARISON_TABLE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.COMPARISON_TYPE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.CREATE_TIME;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.DATABASE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.DATA_TIME;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.DRIVER;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.ERROR_OUTPUT_PATH;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.FAILURE_STRATEGY;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.HDFS_FILE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.INDEX;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.INPUT_TABLE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.OPERATOR;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.OUTPUT_TABLE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.PASSWORD;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.PATH;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.PROCESS_DEFINITION_ID;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.PROCESS_INSTANCE_ID;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.RULE_NAME;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.RULE_TYPE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.SQL;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.SRC_FIELD;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.SRC_FILTER;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.SRC_TABLE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.STATISTICS_EXECUTE_SQL;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.STATISTICS_TABLE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.TABLE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.TARGET_FIELD;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.TARGET_FILTER;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.TARGET_TABLE;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.TASK_INSTANCE_ID;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.THRESHOLD;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.UPDATE_TIME;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.URL;
import static com.reache.ddop.scheduler.plugin.task.api.utils.DataQualityConstants.USER;
...
import com.reache.ddop.scheduler.plugin.task.api.enums.dp.ExecuteSqlType;
import com.reache.ddop.scheduler.plugin.task.api.parser.ParameterUtils;
import com.reache.ddop.scheduler.plugin.task.api.utils.MapUtils;
import com.reache.ddop.scheduler.plugin.task.dq.exception.DataQualityException;
import com.reache.ddop.scheduler.plugin.task.dq.rule.entity.DqRuleExecuteSql;
import com.reache.ddop.scheduler.plugin.task.dq.rule.entity.DqRuleInputEntry;
import com.reache.ddop.scheduler.plugin.task.dq.rule.parameter.BaseConfig;
import com.reache.ddop.scheduler.plugin.task.dq.rule.parameter.EnvConfig;
import com.reache.ddop.scheduler.plugin.task.dq.rule.parser.MappingColumn;
