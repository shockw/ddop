...
package com.reache.ddop.scheduler.plugin.task.api.loop.template.http.parser;
...
import com.reache.ddop.scheduler.plugin.task.api.loop.template.LoopTaskYamlDefinition;
import com.reache.ddop.scheduler.plugin.task.api.loop.template.TaskDefinitionParser;
import com.reache.ddop.scheduler.plugin.task.api.loop.template.http.HttpLoopTaskDefinition;
import com.reache.ddop.scheduler.plugin.task.api.loop.template.http.method.HttpLoopTaskCancelTaskMethodDefinition;
import com.reache.ddop.scheduler.plugin.task.api.loop.template.http.method.HttpLoopTaskQueryStatusMethodDefinition;
import com.reache.ddop.scheduler.plugin.task.api.loop.template.http.method.HttpLoopTaskSubmitTaskMethodDefinition;
