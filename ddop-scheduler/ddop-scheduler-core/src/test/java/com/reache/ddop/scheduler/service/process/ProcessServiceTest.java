...
import com.reache.ddop.scheduler.common.enums.ProcessExecutionTypeEnum;
import com.reache.ddop.scheduler.common.enums.TaskGroupQueueStatus;
import com.reache.ddop.scheduler.common.enums.UserType;
...
import com.reache.ddop.scheduler.plugin.task.api.enums.dp.InputType;
import com.reache.ddop.scheduler.plugin.task.api.enums.dp.OptionSourceType;
import com.reache.ddop.scheduler.plugin.task.api.enums.dp.ValueType;
import com.reache.ddop.scheduler.plugin.task.api.model.ResourceInfo;
import com.reache.ddop.scheduler.spi.params.base.FormType;
...
import com.reache.ddop.scheduler.service.cron.CronUtilsTest;
...
public class ProcessServiceTest {
    ...
    public void testHandleCommand() throws CronParseException, CodeGenerateUtils.CodeGenerateException {
        ...
        Mockito.when(processInstanceMapper.queryByProcessDefineCodeAndProcessDefinitionVersionAndStatusAndNextId(11L, 1,
                com.reache.ddop.scheduler.service.utils.Constants.RUNNING_PROCESS_STATE, 223)).thenReturn(lists);
        ...
        Mockito.when(processInstanceMapper.queryByProcessDefineCodeAndProcessDefinitionVersionAndStatusAndNextId(11L, 1,
                com.reache.ddop.scheduler.service.utils.Constants.RUNNING_PROCESS_STATE, 224)).thenReturn(null);
        ...
        Mockito.when(processInstanceMapper.queryByProcessDefineCodeAndProcessDefinitionVersionAndStatusAndNextId(12L, 1,
                com.reache.ddop.scheduler.service.utils.Constants.RUNNING_PROCESS_STATE, 0)).thenReturn(lists);
