...
import com.reache.ddop.scheduler.common.enums.UdfType;
...
import com.reache.ddop.scheduler.dao.entity.UDFUser;
...
public class UDFUserMapperTest extends BaseDaoTest {
    ...
    private UdfFunc insertOneUdfFunc(){
        ...
        udfFunc.setClassName("com.reache.ddop.scheduler.test.mr");
